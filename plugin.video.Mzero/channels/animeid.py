...
def mainlist(item):
    logger.info("Mzero.channels.animeid mainlist")
...
def search(item,texto):
    logger.info("Mzero.channels.animeid search")
    itemlist = []
...
def novedades_series(item):
    logger.info("Mzero.channels.animeid novedades_series")
...
def novedades_episodios(item):
    logger.info("Mzero.channels.animeid novedades_episodios")
...
def generos(item):
    logger.info("Mzero.channels.animeid generos")
...
def letras(item):
    logger.info("Mzero.channels.animeid letras")
...
def series(item):
    logger.info("Mzero.channels.animeid series")
...
def episodios(item,final=True):
    logger.info("Mzero.channels.animeid episodios")
...
def findvideos(item):
    logger.info("Mzero.channels.animeid findvideos")
    ...
    logger.info("Mzero.channels.animeid data="+data)
