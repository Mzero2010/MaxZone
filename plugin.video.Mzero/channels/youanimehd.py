...
def mainlist(item):
    logger.info("Mzero.channels.youanimehd mainlist")
...
def completo(item):
    logger.info("Mzero.channels.youanimehd completo")
    itemlist = []
...
def letras(item):
    logger.info("Mzero.channels.youanimehd letras")
    itemlist = []
...
def serie(item):
    logger.info("Mzero.channels.youanimehd serie")
    # Descarga la pagina
    data = scrapertools.cache_page(item.url)
    data = data.replace('\n',"")
...
def play(item):
    logger.info("Mzero.channels.youanimehd play url="+item.url)
