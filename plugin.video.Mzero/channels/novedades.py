...
def mainlist(item,thumbnail_type="squares"):
    logger.info("Mzero.channels.novedades mainlist")

    itemlist = []
    list_canales = get_list_canales()

    thumbnail_base = "http://media.tvalacarta.info/Mzero/"+thumbnail_type+"/"
...
def get_list_canales():
    logger.info("Mzero.channels.novedades get_list_canales")
...
def novedades(item):
    logger.info("Mzero.channels.novedades item="+item.tostring())
    ...
    logger.info("Mzero.channels.novedades multithread="+str(multithread))

    list_canales = get_list_canales()

    for channel_name in list_canales[item.extra]:
        logger.info("Mzero.channels.novedades obteniendo novedades de channel_name="+channel_name)
...
def get_newest(channel_name, categoria):
    logger.info("Mzero.channels.novedades get_newest channel_name="+channel_name+", categoria="+categoria)
    ...
    try:
        ...
        logger.info("Mzero.channels.novedades running channel "+modulo.__name__+" "+modulo.__file__)
        list_result = modulo.newest(categoria)
        logger.info("Mzero.channels.novedades.get_newest canal= %s %d resultados" %(channel_name, len(list_result)))

        for item in list_result:
            logger.info("Mzero.channels.novedades.get_newest   item="+item.tostring())
...
def ver_canales(item):
    logger.info("Mzero.channels.novedades ver_canales")
    itemlist = []
...
def menu_opciones(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Canales incluidos en:",
                         thumbnail="http://media.tvalacarta.info/Mzero/" + preferred_thumbnail + "/thumb_configuracion.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="peliculas", title="    - Películas ",
                         thumbnail="http://media.tvalacarta.info/Mzero/" + preferred_thumbnail + "/thumb_canales_peliculas.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="infantiles", title="    - Para niños",
                         thumbnail="http://media.tvalacarta.info/Mzero/" + preferred_thumbnail + "/thumb_canales_infantiles.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="series", title="    - Episodios de series",
                         thumbnail="http://media.tvalacarta.info/Mzero/" + preferred_thumbnail + "/thumb_canales_series.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="anime", title="    - Episodios de anime",
                         thumbnail="http://media.tvalacarta.info/Mzero/" + preferred_thumbnail + "/thumb_canales_anime.png",
                         folder=False))
    itemlist.append(Item(channel=item.channel, action="settingCanal", extra="documentales", title="    - Documentales",
                         thumbnail="http://media.tvalacarta.info/Mzero/" + preferred_thumbnail + "/thumb_canales_documentales.png",
                         folder=False))
