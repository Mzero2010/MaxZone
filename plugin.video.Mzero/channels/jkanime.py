...
def mainlist(item):
    logger.info("Mzero.channels.jkanime mainlist")
...
def ultimos_capitulos(item):
    logger.info("Mzero.channels.jkanime ultimos capitulos")
    itemlist = []
...
def search(item,texto):
    logger.info("Mzero.channels.jkanime search")
    if item.url=="":
...
def ultimos(item):
    logger.info("Mzero.channels.jkanime ultimos")
    itemlist = []
    data = scrapertools.cache_page(item.url)
...
def generos(item):
    logger.info("Mzero.channels.jkanime generos")
    itemlist = []
...
def letras(item):
    logger.info("Mzero.channels.jkanime letras")
    itemlist = []
...
def series(item):
    logger.info("Mzero.channels.jkanime series")
...
def episodios(item):
    logger.info("Mzero.channels.jkanime episodios")
    itemlist = []
