...
def mainlist(item):
    logger.info("Mzero.channels.animeflv mainlist")
...
def menuseries(item):
    logger.info("Mzero.channels.animeflv menuseries")
...
def menuovas(item):
    logger.info("Mzero.channels.animeflv menuovas")
...
def menupeliculas(item):
    logger.info("Mzero.channels.animeflv menupeliculas")
...
def letras(item):
    logger.info("Mzero.channels.animeflv letras")
...
def generos(item):
    logger.info("Mzero.channels.animeflv generos")
...
def search(item, texto):
    logger.info("Mzero.channels.animeflv search")
    if item.url == "":
...
def novedades_episodios(item):
    logger.info("Mzero.channels.animeflv novedades")
...
def series(item):
    logger.info("Mzero.channels.animeflv series")
...
def episodios(item):
    logger.info("Mzero.channels.animeflv episodios")
    itemlist = []
...
def findvideos(item):
    logger.info("Mzero.channels.animeflv findvideos")
...
def numbered_for_tratk(show, season, episode):
    ...
    :rtype: int, int
    """
    logger.info("Mzero.channels.animeflv numbered_for_tratk")
    show = show.lower()
    ...
    logger.info("Mzero.channels.animeflv numbered_for_tratk: "+str(new_season)+":"+str(new_episode))
