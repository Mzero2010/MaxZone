...
def run():
    ...
    try:
        ...
        if hasattr(e, 'reason'):
            logger.info("Mzero.platformcode.launcher Razon del error, codigo: "+str(e.reason[0])+", Razon: " +
                        str(e.reason[1]))
        ...
        if canal:
            platformtools.dialog_ok(
                ...
                "ha cambiado su estructura, o un error interno de Mzero.",
...
def play_from_library(item):
    """
        ...
        "Container.Update()" cargamos el strm como si un item desde dentro de Mzero se tratara, quitando todas
    ...
    if xbmc.getCondVisibility('Window.IsMedia'):
        ...
        p_dialog = platformtools.dialog_progress_bg('Mzero', 'Cargando...')
        p_dialog.update(0, '')
