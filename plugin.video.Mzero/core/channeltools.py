...
DEFAULT_UPDATE_URL = "https://raw.githubusercontent.com/tvalacarta/Mzero/develop/python/main-classic/channels/"
...
def get_channel_remote_url(channel_name):
    ...
    logger.info("Mzero.core.channeltools get_channel_remote_url remote_channel_url="+remote_channel_url)
    logger.info("Mzero.core.channeltools get_channel_remote_url remote_version_url="+remote_version_url)
...
def get_channel_local_path(channel_name):
    ...
    logger.info("Mzero.core.channeltools get_channel_local_path local_channel_path="+local_channel_path)
    logger.info("Mzero.core.channeltools get_channel_local_path local_version_path="+local_version_path)
    logger.info("Mzero.core.channeltools get_channel_local_path local_compiled_path="+local_compiled_path)
