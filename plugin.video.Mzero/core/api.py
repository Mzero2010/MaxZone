...
def remote_call(url,parameters={},require_session=True):
    logger.info("Mzero.core.api.remote_call url="+url+", parameters="+repr(parameters))
...
def plugins_get_all_packages():
    logger.info("Mzero.core.api.plugins.get_all_packages")
...
def plugins_get_latest_packages():
    logger.info("Mzero.core.api.plugins.get_latest_packages")
